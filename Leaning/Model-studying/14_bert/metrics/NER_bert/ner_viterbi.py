...
class Bilstm_crf:
    ...
    def add_bilstm_crf_layer(self, crf_only):
        ...
        print(logits, trans, self.lengths)
        # crf_decode 就是viterbi_decode的tensorflow版本
    ...
    def project_bilstm_layer(self, lstm_outputs, name=None):
        ...
        with tf.variable_scope('project' if name is None else name):
